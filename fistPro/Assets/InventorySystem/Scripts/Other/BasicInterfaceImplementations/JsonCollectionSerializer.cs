...
namespace Devdog.InventorySystem
{
    public class JsonCollectionSerializer : ICollectionSerializer
    {
        ...
        public IList<Models.InventoryItemSaveLookup> DeserializeItems(byte[] data)
        {
            ...
            //var dict = (IDictionary<string, object>)Integration.SimpleJson.DeserializeObject(json);
            var dict = (IDictionary<string, object>)Integration.SimpleJson.SimpleJson.DeserializeObject(json);
