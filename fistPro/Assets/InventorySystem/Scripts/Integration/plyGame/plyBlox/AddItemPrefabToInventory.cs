...
{
    [plyBlock("InventorySystem", "Collections", "Add item prefab to inventory", BlockType.Action, Description = "This adds the item to the \"best\" inventory for the item type and amount. Based on onlyAllowItemsOfType and priority.")]
