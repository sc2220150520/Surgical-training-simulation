...
{
    [plyBlock("InventorySystem", "Collections", "Can add item to collection", BlockType.Condition, ReturnValueType = typeof(Bool_Value), ReturnValueString = "Return - Boolean")]
